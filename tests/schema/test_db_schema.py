...
@pytest.mark.asyncio
async def test_character_table_is_initially_missing(
    empty_sqlite_db_engine: AsyncEngine,
):
    """
    ...
    async with empty_sqlite_db_engine.connect() as connection:
        ...
        ) as excinfo:  # Using ProgrammingError for broad compatibility
            await connection.execute(text("SELECT 1 FROM characters"))

        # Check for a specific error message indicating table absence
        assert "no such table: characters" in str(
            excinfo.value
        ) or 'relation "characters" does not exist' in str(excinfo.value)
...
async def test_talents_table_is_initially_missing(empty_sqlite_db_engine: AsyncEngine):
    ...
    async with empty_sqlite_db_engine.connect() as connection:
        ...
        assert "no such table: talents" in str(
            excinfo.value
        ) or 'relation "talents" does not exist' in str(excinfo.value)


@pytest.mark.asyncio
async def test_talent_trees_table_is_initially_missing(
    empty_sqlite_db_engine: AsyncEngine,
):
    """
    ...
    async with empty_sqlite_db_engine.connect() as connection:
        ...
        assert "no such table: talent_trees" in str(
            excinfo.value
        ) or 'relation "talent_trees" does not exist' in str(excinfo.value)
...
async def test_items_table_is_initially_missing(empty_sqlite_db_engine: AsyncEngine):
    ...
    async with empty_sqlite_db_engine.connect() as connection:
        ...
        assert "no such table: items" in str(
            excinfo.value
        ) or 'relation "items" does not exist' in str(excinfo.value)


@pytest.mark.asyncio
async def test_item_sets_table_is_initially_missing(
    empty_sqlite_db_engine: AsyncEngine,
):
    """
    ...
    async with empty_sqlite_db_engine.connect() as connection:
        ...
        assert "no such table: item_sets" in str(
            excinfo.value
        ) or 'relation "item_sets" does not exist' in str(excinfo.value)
...
async def test_npcs_table_is_initially_missing(empty_sqlite_db_engine: AsyncEngine):
    ...
    async with empty_sqlite_db_engine.connect() as connection:
        ...
        assert "no such table: npcs" in str(
            excinfo.value
        ) or 'relation "npcs" does not exist' in str(excinfo.value)
...
async def test_quests_table_is_initially_missing(empty_sqlite_db_engine: AsyncEngine):
    ...
    async with empty_sqlite_db_engine.connect() as connection:
        ...
        assert "no such table: quests" in str(
            excinfo.value
        ) or 'relation "quests" does not exist' in str(excinfo.value)
...
async def test_spells_table_is_initially_missing(empty_sqlite_db_engine: AsyncEngine):
    ...
    async with empty_sqlite_db_engine.connect() as connection:
        ...
        assert "no such table: spells" in str(
            excinfo.value
        ) or 'relation "spells" does not exist' in str(excinfo.value)
...
async def test_factions_table_is_initially_missing(empty_sqlite_db_engine: AsyncEngine):
    ...
    async with empty_sqlite_db_engine.connect() as connection:
        ...
        assert "no such table: factions" in str(
            excinfo.value
        ) or 'relation "factions" does not exist' in str(excinfo.value)
...
async def test_images_table_is_initially_missing(empty_sqlite_db_engine: AsyncEngine):
    ...
    async with empty_sqlite_db_engine.connect() as connection:
        ...
        assert "no such table: images" in str(
            excinfo.value
        ) or 'relation "images" does not exist' in str(excinfo.value)
