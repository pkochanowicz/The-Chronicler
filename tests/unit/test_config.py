...
class TestSettings:
    ...
    def test_guild_member_role_ids_property(self):
        ...
        with patch.dict(os.environ, {
            "DISCORD_BOT_TOKEN": "test_token_12345",
            "GUILD_ID": "1", "RECRUITMENT_CHANNEL_ID": "1", "CHARACTER_SHEET_VAULT_CHANNEL_ID": "1", "CEMETERY_CHANNEL_ID": "1",
            "WEBHOOK_SECRET": "a_very_long_secret_that_is_at_least_32_chars_long",
    ...
    def test_validate_fails_missing_discord_token(self):
        ...
        with patch.dict(os.environ, {
            "DISCORD_BOT_TOKEN": "",
            "GUILD_ID": "111", "RECRUITMENT_CHANNEL_ID": "222", "CHARACTER_SHEET_VAULT_CHANNEL_ID": "333", "CEMETERY_CHANNEL_ID": "1",
            "WEBHOOK_SECRET": "a_very_long_secret_that_is_at_least_32_chars_long",
            "DATABASE_URL": "sqlite:///:memory:"
        }):
    ...
    def test_reaction_emojis_defined(self):
        ...
        with patch.dict(os.environ, {
            "DISCORD_BOT_TOKEN": "test_token_12345", "GUILD_ID": "1", "RECRUITMENT_CHANNEL_ID": "1", "CHARACTER_SHEET_VAULT_CHANNEL_ID": "1", "CEMETERY_CHANNEL_ID": "1",
            "WEBHOOK_SECRET": "a_very_long_secret_that_is_at_least_32_chars_long",
            "WANDERER_ROLE_ID": "1",
            "DATABASE_URL": "sqlite:///:memory:"
        }):
    ...
    def test_webhook_secret_minimum_length(self):
        ...
        with patch.dict(os.environ, {
            "DISCORD_BOT_TOKEN": "test_token_12345", "GUILD_ID": "111", "RECRUITMENT_CHANNEL_ID": "222", "CHARACTER_SHEET_VAULT_CHANNEL_ID": "333", "CEMETERY_CHANNEL_ID": "1",
